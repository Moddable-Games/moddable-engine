...
const hex = {
  ...
  render(ctx) {
    ...
    if (frame) {
      const borderEdges = computeHexBorderEdges(hexes, size, flat, oX, oY, 1.0)
      parts.push(`<g fill="none" stroke="${colors.stroke}" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">`)
